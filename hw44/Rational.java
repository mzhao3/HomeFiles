...
// Team Gorod -- Oliver Frank, Maggie Zhao, Jackie Li
// APCS1 p02
...
public class Rational implements Comparable{
	...
	Rational someOther = (Rational) other;
	reduce();
	someOther.reduce();
	...
	try {
	    ...
	    thisNumerator = _numerator * someOther._denominator;
	    otherNumerator = _denominator * someOther._numerator;
	    return thisNumerator - otherNumerator;
	}
      
	catch (Exception e) {
	    throw new ClassCastException("Type object is not a Rational, exiting function");
	}
